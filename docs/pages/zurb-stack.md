...
- **Build Options.** By default the inliner works without removing whitespaces and inlining for you, you have to change your settings in the function inliner on your gulpfile.babel.js which is the root of your project. Change this line like this:  ```.pipe($.htmlmin, {
