...
```inky_example
<row class="collapse">
  <columns large="6"><img src="https://placehold.co/300x150/777777/ffffff/?text=These%20columns%20touch" alt=""></columns>
  <columns large="6"><img src="https://placehold.co/300x150/777777/ffffff/?text=These%20columns%20touch" alt=""></columns>
</row>
```
...
```inky_example
<row>
  <columns large="3" class="large-offset-3"><img src="https://placehold.co/150x150/999999/ffffff/?text=offset column" alt=""></columns>
  <columns large="3"><img src="https://placehold.co/150x150/999999/ffffff/" alt=""></columns>
</row>
```
