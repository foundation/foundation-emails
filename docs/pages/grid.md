...
```inky_example
<row class="collapse">
  <columns large="6"><img src="https://placehold.co/300x150/777777/&text=These columns touch" alt=""></columns>
  <columns large="6"><img src="https://placehold.co/300x150/999999/&text=These columns touch" alt=""></columns>
</row>
```
...
```inky_example
<row>
  <columns large="3" class="large-offset-3"><img src="https://placehold.co/150x150/999999/&text=offset column" alt=""></columns>
  <columns large="3"><img src="https://placehold.co/150x150/999999" alt=""></columns>
</row>
```
